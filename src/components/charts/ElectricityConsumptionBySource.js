...
import getElectricityConsumptionBySource from "../../data/adapter/getElectricityConsumptionBySource";
import getCountryLabel from "../../utils/getCountryLabel";

seriesLabel(Highcharts);
highcharts3d(Highcharts);

const ElectricityConsumptionBySource = (props) => {
    ...
    React.useLayoutEffect(() => {
        setDataset(getElectricityConsumptionBySource(country, year))
    }, [])

    React.useEffect(() => {
        setDataset(getElectricityConsumptionBySource(country, (chart !== 'pie' ? null : year)))
    }, [year, country, chart])
        ...
        <>
            ...
            {dataset !== null &&
                <>
                    ...
                    <ChartTitle title={"Consommation d'électricité par source"}/>
                    <ChartSources sourcesName={"OWID"} sourcesLink={"https://ourworldindata.org/electricity-mix"}/>
                </>
            }
        </>
    )
...
export default ElectricityConsumptionBySource;