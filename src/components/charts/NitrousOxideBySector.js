...
import getNitrousOxideBySector from "../../data/adapter/getNitrousOxideEmissionsBySecteur";
import getCountryLabel from "../../utils/getCountryLabel";

seriesLabel(Highcharts);
highcharts3d(Highcharts);

const NitrousOxideEmissionsBySector = (props) => {
    ...
    React.useLayoutEffect(() => {
        setDataset(getNitrousOxideBySector(country, year))
    }, [])

    React.useEffect(() => {
        setDataset(getNitrousOxideBySector(country, (chart !== 'pie' ? null : year)))
    }, [year, country, chart])
        ...
        <>
            ...
            {dataset !== null &&
                <>
                    ...
                    <ChartTitle title={"Émissions de protoxyde d'azote par secteur"}/>
...
export default NitrousOxideEmissionsBySector;