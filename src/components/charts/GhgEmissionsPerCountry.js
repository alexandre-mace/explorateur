...
import getGhgEmissionsPerCountry from "../../data/adapter/getGhgEmissionsPerCountry";

seriesLabel(Highcharts);
highcharts3d(Highcharts);

const GhgEmissionsPerCountry = (props) => {
    ...
    React.useLayoutEffect(() => {
        setDataset(getGhgEmissionsPerCountry(countries, year))
    }, [])

    React.useEffect(() => {
        setDataset(getGhgEmissionsPerCountry(countries, (chart !== 'pie' ? null : year)))
        ...
        <>
            ...
            {dataset !== null &&
                <>
                    ...
                    <ChartTitle title={"Émissions de GES par Pays"}/>
...
export default GhgEmissionsPerCountry;