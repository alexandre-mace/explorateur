...
const Co2BySector = (props) => {
    ...
    React.useLayoutEffect(() => {
        setDataset(getCo2BySector(country, year))
    }, [])

    React.useEffect(() => {
        setDataset(getCo2BySector(country, (chart !== 'pie' ? null : year)))
    }, [year, country, chart])
        ...
        <>
            ...
            {dataset !== null &&
                <>
                    ...
                    <ChartTitle title={"Émissions de CO2 (dioxyde de carbone) par secteur"}/>
