...
const GhgEmissionsBySectorPerCapita = (props) => {
    ...
    React.useLayoutEffect(() => {
        setDataset(getGhgEmissionsBySectorPerCapita(country, year))
    }, [])

    React.useEffect(() => {
        setDataset(getGhgEmissionsBySectorPerCapita(country, (chart !== 'pie' ? null : year)))
    }, [year, country, chart])
        ...
        <>
            ...
            {dataset !== null &&
                <>
                    ...
                    <ChartTitle title={"Émissions de GES (CO2eq) par secteur par personne"}/>
...
export default GhgEmissionsBySectorPerCapita;