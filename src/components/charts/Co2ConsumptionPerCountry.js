...
import getCo2ConsumptionPerCountry from "../../data/adapter/getCo2ConsumptionPerCountry";

seriesLabel(Highcharts);
highcharts3d(Highcharts);

const Co2ConsumptionPerCountry = (props) => {
    ...
    React.useLayoutEffect(() => {
        setDataset(getCo2ConsumptionPerCountry(countries, year))
    }, [])

    React.useEffect(() => {
        setDataset(getCo2ConsumptionPerCountry(countries, (chart !== 'pie' ? null : year)))
        ...
        <>
            ...
            {dataset !== null &&
                <>
                    ...
                    <ChartTitle title={"Émissions de CO2  par Pays (ajusté par la consommation)"}/>
...
export default Co2ConsumptionPerCountry;